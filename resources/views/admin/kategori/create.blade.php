        ...
        <!-- End of Sidebar -->
                ...
                <div class="row justify-content-center mt-1">
                    <div class="col-lg-12 p-3 mb-5">
                        ...
                        <form action="{{ route('kategori.store') }}" method="POST" class="mt-5">
                            @csrf
                            <div class="form-group">
                              <input type="text" name="name" value="{{ old('name') }}" class="form-control" id="exampleInputNama1" aria-describedby="NamaHelp" placeholder="Nama Kategori">
                            </div>
