...
<nav class="navbar navbar-expand-lg custom_nav-container">
    <img src="{{ asset('images/rubik-logo-nav.png') }}" width="180"/>
     <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
     <span class=""> </span>
     </button>
     <div class="collapse navbar-collapse" style="margin-top: -10px;" id="navbarSupportedContent">
          ...
          @else
               <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                     ...
                     <a class="dropdown-item" @if( auth()->user()->role == "admin" ) href="{{ route('home') }}" @else href="{{ url('member/') }}" @endif>
                        Home
                     </a>
