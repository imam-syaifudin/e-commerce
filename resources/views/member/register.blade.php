...
<body style="background-image: linear-gradient(red,#f7444e)">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="{{ route('member.store') }}" class="user">
                                        @csrf
    ...
    <div class="cpy_" style="background-color: inherit">
        <p class="mx-auto">© 2022 All Rights Reserved By <a href="https://imam-syaifudin.github.io" class="text-dark " target="_blank">Muhammad Imam</a><br>  
        </p>
    </div>
    <!-- jQery -->
